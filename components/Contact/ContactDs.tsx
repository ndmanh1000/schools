            ...
            <div className="container">
                ...
                <div className="-mx-4 flex flex-wrap items-stretch">
                    <div className="w-full px-4 lg:w-1/2">
                        <div
                            className="wow fadeInUp mb-12 rounded-sm bg-white px-8 py-11 shadow-three dark:bg-gray-dark sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px] h-full"
                            data-wow-delay=".15s"
                        >
                            {showForm ? (
                                    ...
                                    <div className="-mx-4 flex flex-wrap">
                                        ...
                                        <div className="w-full px-4">
                                            <button
                                                ...
                                                className="rounded-md bg-[#053cc0] px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-primary/80 disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                    ...
                    <div className="w-full px-4 lg:w-1/2">
                        <div className="h-full flex items-center justify-center">
                            <img
                                src={cskkkk.src}
                                alt="cskkkk"
                                className="w-full h-full object-cover rounded-sm shadow-three"
                            />
                        </div>
                    </div>
                </div>
