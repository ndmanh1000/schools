  ...
  return (
    <section id="contact" className="overflow-hidden py-16 md:py-20 lg:py-28 bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative">
      ...
      <div className="container relative z-10">
        <motion.p
          className="py-5 text-center text-3xl font-bold text-black dark:text-white"
        ...
        <div className="-mx-4 flex flex-wrap">
          ...
          >
            <div
              className="wow fadeInUp mb-12 rounded-2xl bg-white/80 backdrop-blur-sm px-8 py-11 shadow-xl border border-gray-200/50 dark:bg-gray-dark/80 dark:border-gray-700/50 sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]"
              data-wow-delay=".15s"
            >
              {showForm ? (
